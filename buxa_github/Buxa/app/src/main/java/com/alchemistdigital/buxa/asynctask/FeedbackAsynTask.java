...
import com.alchemistdigital.buxa.activities.Feedback;
 ...
 */
public class FeedbackAsynTask {
    Context context;
    int loginId;
    String apiKeyHeader, feedback;
    private static ProgressDialog prgDialog;

    public FeedbackAsynTask(Context context, int loginId, String apiKeyHeader, String feedback) {
    ...
    public void sendFeedback() {
        ...
        RestClient.postWithHeader(CommonVariables.SUBMIT_FEEDBACK_SERVER_URL, apiKeyHeader, params, new JsonHttpResponseHandler() {
