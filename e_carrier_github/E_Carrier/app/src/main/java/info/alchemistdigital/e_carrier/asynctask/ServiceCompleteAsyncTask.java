 ...
 */
public class ServiceCompleteAsyncTask extends AsyncTask<String, String, String> {
    String enquiryId;
    Context context;
    ...
    public ServiceCompleteAsyncTask(Context context, int bookingId) {
        enquiryId = String.valueOf(bookingId);
    ...
    protected String doInBackground(String... params) {
        String serverUrl = CommonUtilities.SERVICE_COMPLETE_SERVER_URL;
...
//                            publishProgress((int) ((num / (float) totalSize) * 100));
            ...
            entity.addPart("enquiryId", new StringBody(enquiryId));
