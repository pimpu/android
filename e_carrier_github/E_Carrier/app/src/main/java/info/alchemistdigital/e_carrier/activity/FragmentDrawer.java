...
import info.alchemistdigital.e_carrier.adapter.NavigationDrawerAdapter;
import info.alchemistdigital.e_carrier.model.NavDrawerItem;
...
public class FragmentDrawer extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // get Login name, email and profile pic from shared preference.
        ...
        String email = sharedPreferenceLogin.getString(getResources().getString(R.string.loginEmail), "");
        ...
        txtUserName     = (TextView) layout.findViewById(R.id.idUserName);
        txtUserEmail    = (TextView) layout.findViewById(R.id.idUserEmail);
        ...
        if( !strProfilePic.equalsIgnoreCase("") ){
            ...
            profilePic.setBackground(getResources().getDrawable(R.drawable.ic_profile));
        }
