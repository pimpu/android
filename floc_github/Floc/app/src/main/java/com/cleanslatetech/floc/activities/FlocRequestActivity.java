...
//            new GetFlocAsyncTask( FlocRequestActivity.this, recyclerRunningFloc, recyclerCompletedFloc, recyclerPauseFloc, recyclerCancelFloc, recyclerRequestedFloc, recyclerRequestedFloc, progressBar, btnRefresh ).getData();
        }
    }
}
