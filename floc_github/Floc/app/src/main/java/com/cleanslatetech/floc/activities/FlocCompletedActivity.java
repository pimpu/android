...
//            new GetFlocAsyncTask( FlocCompletedActivity.this, recyclerRunningFloc, recyclerCompletedFloc, recyclerPauseFloc, recyclerCancelFloc, recyclerRequestedFloc, recyclerCompletedFloc, progressBar, btnRefresh ).getData();
        }
    }
}
