...
public class OpenSansAutoCompleteText extends AppCompatAutoCompleteTextView {
    ...
    public OpenSansAutoCompleteText(Context context, AttributeSet attrs, int defStyle) {
    ...
    public OpenSansAutoCompleteText(Context context, AttributeSet attrs) {
        super(context, attrs);
